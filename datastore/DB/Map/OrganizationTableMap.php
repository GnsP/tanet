...
class OrganizationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DB.Map.OrganizationTableMap';
     ...
     */
    const OM_CLASS = '\\DB\\Organization';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DB.Organization';
     ...
     */
    const COL_TYPE = 'organization.type';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Type', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'type', ),
        self::TYPE_COLNAME       => array(OrganizationTableMap::COL_ID, OrganizationTableMap::COL_NAME, OrganizationTableMap::COL_TYPE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'type', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Type' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'type' => 2, ),
        self::TYPE_COLNAME       => array(OrganizationTableMap::COL_ID => 0, OrganizationTableMap::COL_NAME => 1, OrganizationTableMap::COL_TYPE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'type' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DB\\Organization');
        $this->setPackage('DB');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 128, null);
        $this->addColumn('type', 'Type', 'VARCHAR', true, 8, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrganizationTableMap::COL_TYPE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Organization) { // it's a model object
