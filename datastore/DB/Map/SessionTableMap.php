...
class SessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DB.Map.SessionTableMap';
     ...
     */
    const OM_CLASS = '\\DB\\Session';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DB.Session';
     ...
     */
    const COL_UID = 'session.uid';

    /**
     * the column name for the expires field
     */
    const COL_EXPIRES = 'session.expires';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Uid', 'Expires', ),
        self::TYPE_CAMELNAME     => array('id', 'uid', 'expires', ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID, SessionTableMap::COL_UID, SessionTableMap::COL_EXPIRES, ),
        self::TYPE_FIELDNAME     => array('id', 'uid', 'expires', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Uid' => 1, 'Expires' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'uid' => 1, 'expires' => 2, ),
        self::TYPE_COLNAME       => array(SessionTableMap::COL_ID => 0, SessionTableMap::COL_UID => 1, SessionTableMap::COL_EXPIRES => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'uid' => 1, 'expires' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DB\\Session');
        $this->setPackage('DB');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('uid', 'Uid', 'INTEGER', 'user', 'id', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionTableMap::COL_UID);
            $criteria->addSelectColumn(SessionTableMap::COL_EXPIRES);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Session) { // it's a model object
