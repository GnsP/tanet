...
class DocumentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DB.Map.DocumentTableMap';
     ...
     */
    const OM_CLASS = '\\DB\\Document';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DB.Document';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(DocumentTableMap::COL_ID, DocumentTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(DocumentTableMap::COL_ID => 0, DocumentTableMap::COL_NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(DocumentTableMap::COL_ID);
            $criteria->addSelectColumn(DocumentTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DB\Document) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(DocumentTableMap::DATABASE_NAME);
            $criteria->add(DocumentTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(DocumentTableMap::COL_ID) && $criteria->keyContainsValue(DocumentTableMap::COL_ID) ) {
