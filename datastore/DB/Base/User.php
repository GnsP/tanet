...
abstract class User implements ActiveRecordInterface
{
    ...
    /**
     * The value for the premissions field.
     *
     * @var        string
     */
    ...
    /**
     * @var        ChildTeacher one-to-one related ChildTeacher object
     */
    protected $singleTeacher;
    ...
    /**
     * Get the [premissions] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [premissions] column.
     *
     * @param string $v new value
     * @return $this|\DB\User The current object (for fluent API support)
     */
    public function setPremissions($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->premissions !== $v) {
            $this->premissions = $v;
            $this->modifiedColumns[UserTableMap::COL_PREMISSIONS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTableMap::translateFieldName('PasswordHash', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('Premissions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->premissions = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->singleTeacher !== null) {
                if (!$this->singleTeacher->isDeleted() && ($this->singleTeacher->isNew() || $this->singleTeacher->isModified())) {
                    $affectedRows += $this->singleTeacher->save($con);
                }
            }

            if ($this->sessionsScheduledForDeletion !== null) {
                if (!$this->sessionsScheduledForDeletion->isEmpty()) {
                    \DB\SessionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PREMISSIONS)) {
            $modifiedColumns[':p' . $index++]  = 'premissions';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'salt':
                        ...
                        break;
                    case 'premissions':
                        $stmt->bindValue($identifier, $this->premissions, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPasswordHash(),
            $keys[2] => $this->getSalt(),
            $keys[3] => $this->getPremissions(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->singleTeacher) {
                ...
                $result[$key] = $this->singleTeacher->toArray($keyType, $includeLazyLoadColumns, $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setPasswordHash($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setSalt($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setPremissions($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PREMISSIONS)) {
            $criteria->add(UserTableMap::COL_PREMISSIONS, $this->premissions);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPremissions($this->getPremissions());
        ...
        if ($deepCopy) {
            ...
            $relObj = $this->getTeacher();
            if ($relObj) {
                $copyObj->setTeacher($relObj->copy($deepCopy));
            }
    ...
    /**
     * Gets a single ChildTeacher object, which is related to this object by a one-to-one relationship.
     *
    ...
    public function getTeacher(ConnectionInterface $con = null)
    {
        ...
        if ($this->singleTeacher === null && !$this->isNew()) {
            $this->singleTeacher = ChildTeacherQuery::create()->findPk($this->getPrimaryKey(), $con);
        }
    ...
    /**
     * Sets a single ChildTeacher object as related to this object by a one-to-one relationship.
     *
     * @param  ChildTeacher $v ChildTeacher
     * @return $this|\DB\User The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTeacher(ChildTeacher $v = null)
    {
        $this->singleTeacher = $v;

        // Make sure that that the passed-in ChildTeacher isn't already associated with this object
    ...
    public function initSessions($overrideExisting = true)
    {
        ...
        $this->collSessions->setModel('\DB\Session');
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            if ($this->singleTeacher) {
                $this->singleTeacher->clearAllReferences($deep);
            }
