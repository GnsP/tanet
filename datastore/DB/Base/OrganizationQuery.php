...
use \Exception;
use \PDO;
use DB\Organization as ChildOrganization;
 ...
 * @method     ChildOrganizationQuery orderByType($order = Criteria::ASC) Order by the type column
 *
 ...
 * @method     ChildOrganizationQuery groupByType() Group by the type column
 *
 ...
 *
 * @method     ChildOrganization findOneById(int $id) Return the first ChildOrganization filtered by the id column
 * @method     ChildOrganization findOneByName(string $name) Return the first ChildOrganization filtered by the name column
 * @method     ChildOrganization findOneByType(string $type) Return the first ChildOrganization filtered by the type column *
 ...
 * @method     ChildOrganization requireOneByType(string $type) Return the first ChildOrganization filtered by the type column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildOrganization[]|ObjectCollection findByType(string $type) Return ChildOrganization objects filtered by the type column
...
abstract class OrganizationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DB\Base\OrganizationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\DB\\Organization', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, type FROM organization WHERE id = :p0';
        try {
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(OrganizationTableMap::COL_TYPE, $type, $comparison);
    }
