...
use \Exception;
use \PDO;
use DB\District as ChildDistrict;
...
abstract class DistrictQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \DB\Base\DistrictQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\DB\\District', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM district WHERE id = :p0';
        try {
